...
class Messenger:
    ...
    def get_user_id(self):
        try:
            ...
            raise Exception("\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mCookie Không Hợp Lệ")
        ...
        try:
            for url in ['https://www.facebook.com', 'https://mbasic.facebook.com', 'https://m.facebook.com']:
                ...
                if match:
                    ...
                    return
            raise Exception("\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mKhông Tìm Thấy fb_dtsg")
        except Exception as e:
            raise Exception(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mLỗi Khởi Tạo : {str(e)}")
...
def send_messages_thread(messenger, recipient_id, message_list, delay):
    while True:
        ...
        for message in parts:
            ...
            if success:
                status_text = f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mThành Công"
            else:
                status_text = f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mThất Bại"

            print(f"{status_text} | Cookie {messenger.user_id} | Gửi Tới Box : {recipient_id} | Nội Dung : {message}")
...
def main():
    ...
    box_choice = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số : \033[1;36m").strip()

    if box_choice == '1':
        recipient_id = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập ID Box Mới : \033[1;36m").strip()
        if not recipient_id:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mID Box Không Được Để Trống !")
            return
        with open(box_file, "a", encoding="utf-8") as f:
            f.write(recipient_id + "\n")
    elif box_choice == '2':
        if not os.path.exists(box_file):
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mChưa Có ID Box Nào Được Lưu !")
            return
        with open(box_file, "r", encoding="utf-8") as f:
            boxes = [line.strip() for line in f if line.strip()]
        if not boxes:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mDanh Sách Trống !")
            return
        print(f"\n\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mSử Dụng ID Box Đã Lưu : \033[1;36m")
        for idx, b in enumerate(boxes, 1):
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mSố {idx}. {b}")
        try:
            choice = int(input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Lựa Chọn : \033[1;36m"))
    ...
    print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m1\033[1;32m]\033[1;36m Thêm Cookie Mới")
    print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m2\033[1;32m]\033[1;36m Sử Dụng Cookie Đã Lưu")
    cookie_choice = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số : \033[1;36m").strip()

    if cookie_choice == '1':
        try:
            num_cookies = int(input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số Lượng Cookie Muốn Sử Dụng : \033[1;36m"))
            if num_cookies <= 0:
                print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mSố Lượng Cookie Phải Lớn Hơn 0 !")
                return
        except ValueError:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mVui Lòng Nhập Một Số Hợp Lệ !")
            return

        for i in range(num_cookies):
            name = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mTên Người Dùng {i+1} : \033[1;36m").strip()
            c = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mCookie {i+1} : \033[1;36m").strip()
            if not name or not c:
                print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mKhông Được Để Trống !")
                return
            cookies.append(c)
        ...
        if not os.path.exists(cookie_file):
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mChưa Có Cookie Nào Được Lưu !")
            return
        with open(cookie_file, "r", encoding="utf-8") as f:
            lines = [line.strip() for line in f if "|" in line]
        if not lines:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mKhông Có Cookie Hợp Lệ !")
            return
        print(f"\n\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mSử Dụng Tài Khoản : \033[1;36m")
        for idx, line in enumerate(lines, 1):
            name, _ = line.split("|", 1)
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mSố {idx}. {name.strip()}")
        try:
            selected = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Lựa Chọn (1 Hoặc Nhiều Số, Cách Nhau Bởi ',') : \033[1;36m").strip()
            indexes = [int(i)-1 for i in selected.split(",") if i.strip().isdigit()]
            for i in indexes:
                _, ck = lines[i].split("|", 1)
                cookies.append(ck.strip())
        except:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mLỗi Khi Chọn Tài Khoản !")
            return
    else:
        print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mLựa Chọn Không Hợp Lệ !")
        return
    ...
    for i, cookie in enumerate(cookies, 1):
        try:
            m = Messenger(cookie)
            messengers.append(m)
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mCookie {i} : OK - User ID : {m.user_id}")
        except Exception as e:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mCookie {i} : Lỗi - {e}")

    if not messengers:
        print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mKhông Có Cookie Hợp Lệ !")
        return

    try:
        delay = float(input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mDelay Giữa Mỗi Lần Gửi (Giây) : \033[1;36m"))
    except:
        delay = 5

    print(f"\n\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mChọn Kiểu Nội Dung Tin Nhắn :")
    print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m1\033[1;32m]\033[1;36m Nhây Có Dấu\n\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m2\033[1;32m]\033[1;36m Nhây Không Dấu\n\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m1\033[1;32m]\033[1;36m Nhây Réo Tên\n\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m4\033[1;32m]\033[1;36m Tự Nhập Nội Dung Muốn Gửi")
    choice = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;31m: \033[1;36m").strip()
    ...
    if choice == '1':
        ...
        chon_name = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Tên Cần Réo : \033[1;36m").strip()
        if not chon_name:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;31mTên Không Được Để Trống !")
            return
        message_list = [
f"sua di {chon_name}",
...
f"cam hoang loan ma {chon_name}",
        ...
        custom = input(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Nội Dung (Các Câu Cách Nhau Bằng Dấu ',') : \033[1;36m").strip()
        if not custom:
            print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNội Dung Không Được Để Trống !")
            return
        message_list = [custom]
    else:
        print(f"\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mLựa Chọn Không Hợp Lệ !")
    ...
    print(f"\n\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mBắt Đầu Gửi")
    threads = []
