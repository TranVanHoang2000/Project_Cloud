...
for i in range(0, 101):
	sys.stdout.write(f"\r\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mĐang Load Tool [{i}% {'█' * (i // 3)}]")
	sys.stdout.flush()
	sleep(0.003)
...
print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m27\033[1;32m]\033[1;36m Tool Encode TVH [Vip]')
print (Colorate.Diagonal(Colors.blue_to_green, "══════════════════════════════════════════════════════════════"))
print (Colorate.Diagonal(Colors.rainbow, "╔════════════════╗"))
print (Colorate.Diagonal(Colors.rainbow, "║  Tool Zalo     ║"))
print (Colorate.Diagonal(Colors.rainbow, "╚════════════════╝"))
print(f'\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhập Số \033[1;32m[\033[1;31m28\033[1;32m]\033[1;36m Tool Spam Zalo [New]')
...
if chon == '0' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/0.py').text)
elif chon == '1' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/1.py').text)
elif chon == '2':
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/2.py').text)
elif chon == '3' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/3.py').text) 
elif chon == '4' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/4.py').text) 
elif chon == '5' : 
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/5.py').text) 
elif chon == '6' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/6.py').text)
elif chon == '7' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/7.py').text)
elif chon == '8' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/8.py').text)
elif chon == '9' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/9.py').text)
elif chon == '10' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/10.py').text)
elif chon == '11' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/11.py').text)
elif chon == '12' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/12.py').text)
elif chon == '13' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/13.py').text)
elif chon == '14' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/14.py').text)
elif chon == '15' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/15.py').text)
elif chon == '16' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/16.py').text)
elif chon == '17' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/17.py').text)
elif chon == '18' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/18.py').text)
elif chon == '19' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/19.py').text)
elif chon == '20' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/20.py').text)
elif chon == '21' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/21.py').text)
elif chon == '22' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/22.py').text)
elif chon == '23' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/23.py').text)
elif chon == '24' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/24.py').text)
elif chon == '25' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/25.py').text)
elif chon == '26' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/26.py').text)
elif chon == '27' :
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/27.py').text)
elif chon == '28' :
	print("\033[1;32m[\033[1;31m♤\033[1;32m]\033[1;33m ➩ \033[1;32mNhớ Có Zlapi, Chưa Có Thì Tải - Link : https://www.mediafire.com/file/4cr7j6p3kiisaa8/zlapi.zip/file")
	exec(requests.get('https://raw.githubusercontent.com/TranVanHoang2000/Project_Cloud/main/Choice/28.py').text)
else:
